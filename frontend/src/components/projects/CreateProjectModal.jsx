    ...
    >
      <div className="w-full max-w-lg bg-surface-container-lowest rounded-xl shadow-elevated p-8 animate-in fade-in zoom-in-95 duration-200">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="headline-md text-stone-900">Create New Project</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            <label className="label-md text-stone-900" htmlFor="projectName">Project Name</label>
            <input
              id="projectName"
              type="text"
              value={name}
          ...
          <div className="flex flex-col gap-1">
            <label className="label-md text-stone-900" htmlFor="projectDesc">Description (Optional)</label>
            <textarea
              id="projectDesc"
              value={description}
